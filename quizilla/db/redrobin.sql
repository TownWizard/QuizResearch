...
values (38,18,'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
  <head>
    <title>synapse red robin customer survey</title>
    ...
    <style type="text/css">
        ...
        .header_wrapper {
		 ...
		 border-bottom: 3px #801f19 solid;
        ...
        .survey_bg {
            min-height: 350px;
            border-left: 3px #801f19 solid;
            border-right: 3px #801f19 solid;
        }
        .survey {
            padding: 15px;
        ...
        .progress_bar_wrapper {
          background: url("/images/surveys/synapse/redrobin/progress_bar.gif") no-repeat top left;
          width: 693px;
          height: 18px;
        }
        .progress_bar {
          margin-left: 83px;
          background: url("/images/surveys/synapse/redrobin/progress_bar_on.gif") repeat-x top left;
          text-align: right;
          color: #fff;
  ...
  <body>
    <div class="header_wrapper">
        <div class="header">
            <img src="/images/surveys/synapse/redrobin/logo_RDRO.gif" alt="red robin" style="margin: 4px 0 0 0px;" />
        </div>
    </div>
    ...
    <div class="footer_wrapper">
        <div class="footer">
            <img src="/images/surveys/synapse/redrobin/powered_by_synapse.gif" alt="Powered by Synapse" style="vertical-align: bottom; margin: 15px 15px 0 9px;" />
