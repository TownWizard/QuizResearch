...
set :application, "quizilla"

set :repository, "https://svn.assembla.com/svn/gds_starter/#{application}"
...
role :web,      "ec2-50-17-157-38.compute-1.amazonaws.com"
role :app,      "ec2-50-17-157-38.compute-1.amazonaws.com", :primary => true
role :db,       "ec2-50-17-157-38.compute-1.amazonaws.com"
role :memcache, "ec2-50-17-157-38.compute-1.amazonaws.com"
...
set :ec2onrails_config, {
  ...
  :mysql_root_password => "kindlerock123",
...
#  :packages => ["logwatch", "imagemagick"],
  ...
  # remove this.
  :admin_mail_forward_address => "nimesh.nikum@aaditsoftware.com",
